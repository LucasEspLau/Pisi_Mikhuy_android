...
public class ActSobreNosotrosNull extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyt_sobre_nosotros_null);
        recuperarDatos();
        asignarReferencias();
    ...
    private void asignarReferencias() {
        ...
        inicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ActSobreNosotrosNull.this, ActMainNull.class);
        ...
        registro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ActSobreNosotrosNull.this, ActRegistroCliente.class);
        ...
        iniSesion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ActSobreNosotrosNull.this, ActIniSesion.class);
            }
        });
        ...
        preguntas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ActSobreNosotrosNull.this, ActPreguntasFrecuentesNull.class);
            }
        });
    }
