...
public class ActPreguntasFrecuentesCliente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyt_preguntas_frecuentes_cliente);
        recuperarDatos();
        asignarReferencias();
    ...
    private void asignarReferencias() {
        ...
        inicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ActPreguntasFrecuentesCliente.this, ActMainCliente.class);
        ...
        catalogo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ActPreguntasFrecuentesCliente.this, ActCatalogo.class);
        ...
        premio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ActPreguntasFrecuentesCliente.this, ActPremio.class);
            }
        });
        nosotros.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ActPreguntasFrecuentesCliente.this, ActSobreNosotrosCliente.class);
            }
        });
        informacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ActPreguntasFrecuentesCliente.this, ActInfoCliente.class);
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder=
                        new AlertDialog.Builder(ActPreguntasFrecuentesCliente.this  );
                builder.setMessage("¿Desea cerrar sesión?")
                        .setTitle("Confirmación")
                        .setPositiveButton("Sí", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialogInterface, int i) {
                                redirectActivity(ActPreguntasFrecuentesCliente.this, ActMainNull.class);
                                Toast.makeText(ActPreguntasFrecuentesCliente.this, "Sesión cerrada", Toast.LENGTH_LONG).show();
                            }
                        })
